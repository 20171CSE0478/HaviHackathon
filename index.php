...
#reg{
	border-radius: 24px;
    box-shadow: 4px 12px 12px #5c5d7b;
    width: 20%;
    height: 447px;
	margin-left: 276px;
    margin-top: 112px;
    background: rgb(2,0,36);
background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(0,212,255,1) 0%, rgba(133,19,171,1) 62%);
}
#t{
...
<body>
<h1 id="mainh">USER REGISTRATION/LOGIN </h1>
<div class="main">
